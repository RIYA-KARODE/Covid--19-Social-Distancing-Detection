...
#vid_path = input("Enter video name:")

vid_path = "videos/test video 2.mp4"
...
np.random.seed(42)
weightsPath = "yolov4-tiny.weights"                                                                                ## https://pjreddie.com/media/files/yolov3-tiny.weights
configPath = "yolov4-tiny.cfg"                                                                                        ## https://github.com/pjreddie/darknet/blob/master/cfg/yolov3-tiny.cfg
...
while True:
    ...
    if len(idxs) > 0:
        ...
        for i in idf:
            ...
            cv2.putText(frame, "COVID-19 Social Distancing Detection ", (210, 45),
        ...
        cv2.imshow('Covid 19 Social distancing Detection', frame)
        cv2.waitKey(1)
